        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <br />
              <a
                href="mailto:nazimameerpp@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+91 9778 539 006</span>
              <br />
              <a
                href="https://wa.link/7w5ia3"
                className="contact__button"
              >
                Write me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">@naaazm</span>
              <br />
              <a
                href="https://www.instagram.com/naaazm/"
                className="contact__button"
              >
                Write me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
